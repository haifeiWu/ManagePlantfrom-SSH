...
<body>
	<form class="container" action="${pageContext.request.contextPath }/AR_addActivityRecordInfor.action" method="post">
		<div class="row">
			<!--嫌疑人入区信息-->
			...
			<div class="container" style="margin-top: 0%;">
				<div class="row">
					<!--身份信息标题-->
					<h4 class="human_Mes col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 0%;">入区事由:<input type="text" value="治安传唤" /></h4>
			...
			<p class="row_1">注：1、按照公安部规定，嫌疑人进入办案区，需完整完成“入区登记、人身检查及信息采集”流程后<br />方可进行询问讯问等后续工作;</p>
			<p class="row_2">2、请办案民警注意对嫌疑人在办案区的活动做详细记录，确保嫌疑人在办案区内无时间盲区的登记<br />遗漏.</p>

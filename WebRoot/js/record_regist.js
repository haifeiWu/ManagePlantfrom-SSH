$(document).ready(function () {
	...
	//设置所有input标签的属性样式
	$(".Message tr td :input").css({
		"width": "18%", "color": "#080808", "text-align": " center",
	...
	$(".active_check input:lt(4)").css("width", "65%");
	$(".active_check input").css("text-align", "center");
	//	设置human_mes样式
	//第一个标题
	...
	$(".human_Mes span input").css({
		"color": "rgb(211,26,23)", "font-size": "small", "width": "38px",
	});
});
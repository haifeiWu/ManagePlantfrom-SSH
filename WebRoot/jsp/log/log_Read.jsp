...
<html>
  <head>
    ...
    <title>My JSP 'log_Read.jsp' starting page</title>
  ...
  <body>  
    ...
    <h1><font color="blue">日志查信息</font></h1><hr>  
 ...
 <s:iterator value="#request.pageBean.list" id="pb">
    ...
    <center>  
        ...
        <font size="5">当前页<font color="red"><s:property value="#request.pageBean.currentPage"/></font></font><br><br>  
        ...
        <s:else>  
            ...
            <a href="${pageContext.request.contextPath }/Log_execute.action?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>  
        </s:else>  
          
        <s:if test="#request.pageBean.currentPage != #request.pageBean.totalPage">  
            <a href="${pageContext.request.contextPath}/Log_execute.action?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>  
                 
            <a href="${pageContext.request.contextPath}/Log_execute.action?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>  
        </s:if>  

...
public class PropertiesWriteUtils {
    ...
    public static void main(String []args) throws UnsupportedEncodingException{
		...
		System.out.println(PropertiesReadUtils.getRecordConfString("remoteServerIP"));
		
    	map.put("remoteServerIP", "198.0.0.1");
    	map.put("remoteServerPort", "120");
    	String str="http://"+
    	map.put("StartRecording","http://"+PropertiesReadUtils.getRecordConfString("remoteServerIP")+":"+
    			PropertiesReadUtils.getRecordConfString("remoteServerPort")+"/SxStartRecording.psp");
    	updateProperties("recordConf.properties", map);
    	System.out.println(PropertiesReadUtils.getRecordConfString("StartRecording"));

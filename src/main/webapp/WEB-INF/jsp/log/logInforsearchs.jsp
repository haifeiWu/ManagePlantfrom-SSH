...
<script type="text/javascript">
	function validate() {
		...
		if ( page>${pageBean.totalPage}|| (page == undefined&& page == "")) {
			...
			$("body").load("${pageContext.request.contextPath}/log/loginfosearchs?page=1");
...
<body>
	...
	<div>
		<center>
			...
			<c:otherwise>
				<a
					href="${pageContext.request.contextPath }/log/loginfosearchs?page=1">首页</a>
				<a
					href="${pageContext.request.contextPath }/log/loginfosearchs?page=${ pageBean.currentPage - 1}">上一页</a>
			</c:otherwise>
			</c:choose>
			<c:choose>
			<c:when
				...
				<a
					href="${pageContext.request.contextPath}/log/loginfosearchs?page=${ pageBean.currentPage + 1}">下一页</a>
				<a
					href="${pageContext.request.contextPath}/log/loginfosearchs?page=${ pageBean.totalPage}">尾页</a>
			</c:when>
		...
		<center>
			...
			<form action="${pageContext.request.contextPath}/log/loginfosearchs" onsubmit="return validate();">

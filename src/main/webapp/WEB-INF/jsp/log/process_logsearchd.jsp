...
<script type="text/javascript">
	function validate() {
		...
		if ( page>${pageBean.totalPage}|| (page == undefined&& page == "")) {
			...
			$("body").load("${pageContext.request.contextPath}/log/logprocesssearchd?page=1");
...
<body>
	...
	<br>
		<center>
			...
			<c:otherwise>
				<a
					href="${pageContext.request.contextPath }/log/logprocesssearchd?page=1">首页</a>
				<a
					href="${pageContext.request.contextPath }/log/logprocesssearchd?page=${ pageBean.currentPage - 1}">上一页</a>
			</c:otherwise>
			</c:choose>
			<c:choose>
			<c:when
				...
				<a
					href="${pageContext.request.contextPath}/log/logprocesssearchd?page=${ pageBean.currentPage + 1}">下一页</a>
				<a
					href="${pageContext.request.contextPath}/log/logprocesssearchd?page=${ pageBean.totalPage}">尾页</a>
			</c:when>
